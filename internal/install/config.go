...
//
// Every key is commented out. mindskein has no useful default for the
// priorities file, and a file that guesses one would produce a priorities
// section that silently reads the wrong note. Commented keys document what can be set
...
# [priorities]
# The note holding your !1/!2 priority lines. Absolute, or a leading ~.
# file = "/Users/you/Notes/plan.md"
